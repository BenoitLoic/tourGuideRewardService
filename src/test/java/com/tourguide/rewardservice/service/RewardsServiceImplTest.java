...
class RewardsServiceImplTest {
    ...
    @Mock
    RewardRepository rewardRepositoryMock;
    ...
    void calculateRewards() {
        ...
        int result = rewardsService.calculateRewards(userId, attractionId1);
        // THEN
    ...
    void calculateRewards_ShouldThrowIllegalArgumentException() {
        ...
        // THEN
        assertThrows(IllegalArgumentException.class, () -> rewardsService.calculateRewards(userId, null));
        assertThrows(IllegalArgumentException.class, () -> rewardsService.calculateRewards(null, attractionId1));
    }
    ...
    void addReward() {
        ...
        // GIVEN
        Attraction attraction1 = new Attraction("attractionNameTest1",
                "cityTest",
                "stateTest",
                attractionId1,
                new Location(50, 120));
